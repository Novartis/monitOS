...
app_ui <- function(request) {
  ...
  shinydashboard::dashboardPage(
    ...
    shinydashboard::dashboardBody(
      ...
      fluidRow(box(
        title = "Instruction for use", collapsed = TRUE, collapsible = TRUE, width = 12, status = "primary",
      ...
      fluidRow(
        box(
          title = "Unacceptable detrimental effect", collapsed = TRUE, collapsible = TRUE, width = 12, status = "info",
      ...
      fluidRow(
        box(
          title = "Plausible beneficial effect", collapsed = TRUE, collapsible = TRUE, width = 12, status = "info",
      ...
      fluidRow(
        box(
          title = "Expected deaths at Final Analysis", collapsed = TRUE, collapsible = TRUE, width = 12, status = "info",
      ...
      fluidRow(
        box(
          title = "Expected deaths at trial Primary Analysis", collapsed = TRUE, collapsible = TRUE, width = 12, status = "info",
      ...
      fluidRow(
        box(
          title = "False positive error rate", collapsed = TRUE, collapsible = TRUE, width = 12,
      ...
      fluidRow(
        box(
          title = "Power required", collapsed = TRUE, collapsible = TRUE, width = 12,
      ...
      fluidRow(box(
        title = "Optional Parameters", collapsible = TRUE, collapsed = TRUE, width = 12,
        fluidRow(
