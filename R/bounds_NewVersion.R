...
#' @param power Scalar. Should be NULL if the user specifies t1error. If t1error is NULL, the user specifies
...
#'
#' @examples
bounds_v2 <- function(events,  # label for UI: target number of OS events at each analysis
