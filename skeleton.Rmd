...
We tested all our functions against published clinical trials information. The code replicates all (5) tables from our peer-reviewed papers to ensure reproducibility. 
...
Three people were involved in the code development and review process of the code:
- Thibaud Coroller, PhD: Data scientist
- Evanthia Koukouli, PhD: Trial statistician
- Lisa Hampson, PhD: Statistical consultant

Additionally, 

- Dominic Magirr, PhD: Statistical consultant performed code review for existing regulatory question(s) using the package, validated code outputs and scientific method.

In all the process of code development, best practices were followed. Code was tested and reviewed before any push to `main` branch. Code also passed CRAN guidelines and is hosted since Winter 2023. 
...
-->
...
errors <- system(sprintf("grep --include 00check.log -rnwP 'Status: \\d ERROR' %s", checkPath), intern=T)
